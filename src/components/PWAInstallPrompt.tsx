...
import { UserIcon, LockClosedIcon, ArrowDownTrayIcon, XCircleIcon } from '@heroicons/react/24/outline'
      ...
      <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-4">
        ...
        <div className="flex justify-between items-start mb-3">
          ...
          <button
            ...
            className="ml-2 p-1 hover:bg-gray-100 rounded-lg transition shrink-0"
            aria-label="Close"
          >
